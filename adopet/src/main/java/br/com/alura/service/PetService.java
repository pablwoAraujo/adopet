...
public class PetService {
	...
	private HttpResponse<String> triggerGetRequest(HttpClient client, String uri)
	...
	private HttpResponse<String> triggerPostRequest(HttpClient client, String uri, JsonObject json)
			throws IOException, InterruptedException {
